      ...
      <div>
        <form onSubmit={this.updatePassword} className="form" role="form" action="/api/user/profile/password" enctype="multipart/form-data" method="PUT">
          <fieldset>
            ...
            <input type="password" name="newpassword" placeholder="Confirm new password" ref="newPasswordConfirmation" />
            <button type="submit" className="button small expand profile-submit">Update Password</button>
          </fieldset>
        </form>
      </div>
    );
